...
namespace ArtemisBankingPro.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810180553_AllowCardAssignedOperationAmounts")]
    partial class AllowCardAssignedOperationAmounts
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("FinancialOperations", "dbo", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FinancialOperations_Requested_Positive", "([RequestedAmount] > 0 AND [Kind] NOT IN (15, 16, 17)) OR ([Kind] IN (15, 16, 17) AND [RequestedAmount] = 0)");
                        });
                });
