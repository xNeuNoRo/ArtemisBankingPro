...
namespace ArtemisBankingPro.Infrastructure.Persistence.Migrations {
    /// <inheritdoc />
    public partial class AllowAccountCancelledOperationAmounts : Migration {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.AddCheckConstraint(
                ...
                schema: "dbo",
                table: "FinancialOperations",
                sql: "([RequestedAmount] > 0 AND [Kind] NOT IN (15, 16, 17, 18)) OR ([Kind] IN (15, 16, 17, 18) AND [RequestedAmount] = 0)");
        }
