...
namespace ArtemisBankingPro.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810032559_AllowCardCancelledOperationAmounts")]
    partial class AllowCardCancelledOperationAmounts
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("FinancialOperations", "dbo", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FinancialOperations_Requested_Positive", "([RequestedAmount] > 0 AND [Kind] <> 15) OR ([Kind] = 15 AND [RequestedAmount] = 0)");
                        });
                });
