...
namespace ArtemisBankingPro.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810042959_AllowCardLimitChangedOperationAmounts")]
    partial class AllowCardLimitChangedOperationAmounts
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("FinancialOperations", "dbo", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FinancialOperations_Requested_Positive", "([RequestedAmount] > 0 AND [Kind] NOT IN (15, 16)) OR ([Kind] IN (15, 16) AND [RequestedAmount] = 0)");
                        });
                });
